...
public class ItemAxeBasis extends ItemToolBasis {
	...
	public static final Set<Block> blocksEffectiveAgainst = Sets.newHashSet(new Block[] { Blocks.planks, Blocks.bookshelf, Blocks.chest, Blocks.stone_slab, Blocks.pumpkin });
